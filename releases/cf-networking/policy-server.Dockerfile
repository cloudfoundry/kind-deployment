...
COPY --from=builder /usr/local/bin/policy-server /usr/local/bin/policy-server
COPY --from=builder /usr/local/bin/policy-server-internal /usr/local/bin/policy-server-internal
COPY --from=builder /usr/local/bin/policy-server-asg-syncer /usr/local/bin/policy-server-asg-syncer
