...
# Source: https://github.com/openresty/docker-openresty/blob/2c318a28be8d692523430f336c46ee90808d420a/alpine/Dockerfile
# Standard OpenResty Dockerfile for Alpine Linux with the additional module "nginx-dav-ext-module"
...
ARG RESTY_CONFIG_OPTIONS="\
    ...
    --with-threads \
    "
ARG RESTY_CONFIG_OPTIONS_MORE="--add-module=/tmp/nginx-dav-ext-module-3.0.0"
...
RUN apk add --no-cache --virtual .build-deps \
    ...
    && cd /tmp \
    && curl -fSL https://github.com/arut/nginx-dav-ext-module/archive/refs/tags/v3.0.0.tar.gz -o nginx-dav-ext-module-3.0.0.tar.gz \
    && tar xzf nginx-dav-ext-module-3.0.0.tar.gz \
    ...
    && rm -rf \
        ...
        nginx-dav-ext-module-3.0.0.tar.gz nginx-dav-ext-module-3.0.0 \
